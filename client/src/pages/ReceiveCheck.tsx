...
export default function ReceiveCheck() {
  ...
  return <div className="mx-auto max-w-5xl"><div className="mb-6"><p className="mb-2 text-sm font-semibold text-primary">ตรวจรับสินค้า</p><h1 className="text-2xl font-bold tracking-tight lg:text-3xl">เช็คของเข้าจากรายการสั่งซื้อ</h1><p className="mt-1 text-sm text-muted-foreground">สแกน barcode จากกล้องมือถือ แล้วบันทึกจำนวนที่ได้รับจริงเพื่อเทียบกับจำนวนที่สั่ง</p></div>
